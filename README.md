...
npm install -g pnpm
npm install esno
查看service/service.log和front.log，确保服务能正常启动；
sh -x ./start.sh
然后设置API
```

## 声明
- 本开源是在 [Dooy](https://github.com/Dooy/chatgpt-web-midjourney-proxy) 基础上做二次开发 ；使用 [midjourney-proxy](https://github.com/novicezk/midjourney-proxy) 、 Suno-API、[Luma-API](https://github.com/LumaAI-API/Luma-API)  作为后端API而形成的；
...
## 无服务器-个人桌面安装
> - [x] 请到 https://github.com/byteverse888/AIGC-app-Web/releases 下载最新版本安装(选择合适你操作系统的版本)
